...
################################################################
# This is a generated script based on design: pwm_generator_system
#
...
# source pwm_generator_system_script.tcl
...
set design_name pwm_generator_system
...
CONFIG.NUM_MI {2} \
  ...
  # Create instance: modulator_axi_ip_0, and set properties
  set modulator_axi_ip_0 [ create_bd_cell -type ip -vlnv so-logic:modulator:modulator_axi_ip:1.0 modulator_axi_ip_0 ]
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M00_AXI [get_bd_intf_pins microblaze_0_axi_periph/M00_AXI] [get_bd_intf_pins modulator_axi_ip_0/S00_AXI]
  ...
  connect_bd_net -net modulator_axi_ip_0_pwm_out [get_bd_ports pwm_out] [get_bd_pins modulator_axi_ip_0/pwm_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins modulator_axi_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins modulator_axi_ip_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs modulator_axi_ip_0/S00_AXI/S00_AXI_reg] SEG_modulator_axi_ip_0_S00_AXI_reg
...
preplace port sws_4bits -pg 1 -y 220 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 310 -defaultsOSRD
preplace port pwm_out -pg 1 -y 70 -defaultsOSRD
preplace inst modulator_axi_ip_0 -pg 1 -lvl 2 -y 100 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 2 -y 310 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -y 220 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 170 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 380 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 410J 450 NJ 450 940J
preplace netloc modulator_axi_ip_0_pwm_out 1 2 2 NJ 100 940
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 390
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 10 730
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 0 80 380
preplace netloc microblaze_0_axi_periph_M00_AXI 1 1 2 450 30 710
preplace netloc processing_system7_0_FIXED_IO 1 1 3 400J 460 NJ 460 950J
preplace netloc microblaze_0_axi_periph_M01_AXI 1 2 1 740
preplace netloc axi_gpio_0_GPIO 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -10 70 420 170 720
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 430
levelinfo -pg 1 -30 190 580 840 970 -top -10 -bot 520
",
}
