...
HD_PWD='C:/EAAES/assignments/pwm_generation/pwm_generation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_generator_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_generator_system_wrapper.tcl -notrace
