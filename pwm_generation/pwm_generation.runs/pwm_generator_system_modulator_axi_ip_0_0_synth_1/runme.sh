...
HD_PWD='C:/EAAES/assignments/pwm_generation/pwm_generation.runs/pwm_generator_system_modulator_axi_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_generator_system_modulator_axi_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_generator_system_modulator_axi_ip_0_0.tcl
